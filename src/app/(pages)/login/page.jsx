			...
			<main>
				<section>
					...
					<form action="#" onSubmit={onSubmit}>
						...
						<BotaoPadrao tipo="submit" texto="Entrar"></BotaoPadrao>
					</form>
					<span>
				...
				<dialog>
					<div>
						<h1>Erro</h1>
						<p>
							Houve um erro ao tentar fazer login, tente novamente mais
							tarde ou acesse o console para mais detalhes
						</p>
				...
				<dialog open={refused}>
					<div>
						...
						<p>
							Email ou senha incorretos, verifique os dados e tente
							novamente
						</p>
